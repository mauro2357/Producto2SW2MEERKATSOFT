...
public class listadodepedidosencolaStepDefinitions {
	...
	public void Agregar_el_pedido_a_la_cola_de_pedidos() throws Throwable {
	    ...
	    Assert.assertEquals("Pedido enviado", mesero.enviar_pedido(null, null, null, null, null, null, null, null));
	}
	...
	public void Notificar_que_no_hay_productos_en_el_pedido() throws Throwable {
		Assert.assertTrue("No hay productos."!=mesero.enviar_pedido(null, null, null, null, null, null, null, null));
	}
